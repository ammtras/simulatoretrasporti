...
'''class ZonaTariffaria(models.Model):
    nome =  models.ForeignKey(Zona,on_delete=models.CASCADE,related_name="zona_tariffariaa")
    zona_da = models.ForeignKey(Zona,on_delete=models.CASCADE,related_name="zona_da_tariffarie")
    zona_a = models.ForeignKey(Zona,on_delete=models.CASCADE,related_name="zona_a_tariffarie")
...
class Zona_spedizioniere(models.Model):
    ...
    def __str__(self):
        return f"{self.spedizioniere} & {self.zona}"
